...
<html lang="en">
  <head>
    ...
    <title>Halaman Profil Pengguna Lulusan</title>
  </head>
  <body>
    ...
    <nav class="navbar navbar-light bg-light p-3">
      <div class="container-fluid">
        <a class="navbar-brand">Sikepku Pengguna Lulusan</a>
      <div class="container-end">
        <a href="profil-dosen.php" class="px-3"><img src="Asset-img/pengguna-lulusan.svg" alt="" width="40" height="34" ></a>
        ...
        <div class="col-md-10">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <!-- Alamat -->
              <label for="username" class="form-label">Alamat Kantor</label>
              <div class="input-group mb-3">
              ...
              <label for="email" class="form-label">Jumlah Pegawai</label>
              <div class="input-group mb-3">

                <input type="text" class="form-control" id="email" name="email" required placeholder="Masukan Status" aria-describedby="basic-addon3">
              </div>
              <!-- Jumlah Pegawai Alumni UHO -->
              <label for="email" class="form-label">Jumlah Pegawai Alumni UHO</label>
              <div class="input-group mb-3">
