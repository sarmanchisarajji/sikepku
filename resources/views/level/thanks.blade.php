                ...
                <div class="card-body custom-card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 d-flex justify-content-center align-items-center h-100">
                            <div class="thanks">
                                <p class="text-center">Terima kasih telah mengisi survei! Pendapat <br>Anda sangat berharga bagi kami.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-12 d-flex justify-content-center align-items-center h-100">
                            <div class="illus">
                                <a href="logout.html" class="btn btn-outline-dark" id="logoutBtn"><h4>Keluar dari Survei</h4></a>
                            </div>
                        </div>
                    </div>
                </div>
