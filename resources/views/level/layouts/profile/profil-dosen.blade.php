    ...
    <nav class="navbar navbar-light bg-light p-3">
        <div class="container-fluid">
            ...
            <div class="container-end">
                <a href="profil-dosen.php" class="px-3"><img src="Asset-img/dosen.svg" alt="" width="40"
                        height="34"></a>
                    ...
                    <form action="">
                        <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="email" name="email" required
                                    placeholder="Masukan Status" aria-describedby="basic-addon3">
                            </div>
                            <!-- Jabatan Fungsional -->
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="email" name="email" required
                                    placeholder="Masukan Jabatan Fungsional" aria-describedby="basic-addon3">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="email" name="email" required
                                    placeholder="Masukan Jabatan Tugas Tambahan" aria-describedby="basic-addon3">
                            </div>
                            <!-- Lama Bekerja di UHO  -->
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="email" name="email" required
                                    placeholder="Masukan Lama Bekerja" aria-describedby="basic-addon3">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="email" name="email" required
                                    placeholder="Masukan Tingkat Pendidikan" aria-describedby="basic-addon3">
                            </div>
