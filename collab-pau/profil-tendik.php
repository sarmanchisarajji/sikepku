...
<html lang="en">
  <head>
    ...
    <title>Halaman Profil Tendik</title>
  </head>
  <body>
    ...
    <nav class="navbar navbar-light bg-light p-3">
      <div class="container-fluid">
        <a class="navbar-brand">Sikepku Tendik</a>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-10">
          <h1 class="display-3 text-start fw-bold mt-3">Khairul Andina</h1>
        ...
        <div class="col-md-10">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <!-- NIP/Nomor Kontrak -->
              <label for="username" class="form-label">NIP/Nomor Kontrak</label>
              <div class="input-group mb-3">
              ...
              <!-- Status Tendik -->
              <label for="email" class="form-label">Status Tendik</label>
              <div class="input-group mb-3">
              ...
              <!-- Unit Kerja (Prodi/Jurusan; UPT; Fakultas; Pasca;	PPV; Lembaga; dst-nya) -->
              ...
              <label for="email" class="form-label">Tingkat Pendidikan</label>
              <div class="input-group mb-3">
