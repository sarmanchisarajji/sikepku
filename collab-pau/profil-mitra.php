...
<html lang="en">
  <head>
    ...
    <title>Halaman Profil Mitra</title>
  </head>
  <body>
    ...
    <nav class="navbar navbar-light bg-light p-3">
      <div class="container-fluid">
        <a class="navbar-brand">Sikepku Mitra</a>
      <div class="container-end">
        <a href="profil-mitra.php" class="px-3"><img src="Asset-img/Mitra.svg" alt="" width="40" height="34" ></a>
        ...
        <div class="col-md-10">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <!-- Instansi/Lembaga -->
              <label for="email" class="form-label">Instansi/Lembaga</label>
              <div class="input-group mb-3">
              ...
              <!-- Bidang Kerjasama -->
              <label for="email" class="form-label">Bidang Kerjasama</label>
              <div class="input-group mb-3">
