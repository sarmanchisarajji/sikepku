...
<body>
    ...
    <nav class="navbar navbar-light bg-light p-3">
        <div class="container-fluid">
            <a class="navbar-brand">Sikepku Alumni</a>
            <div class="container-end">
                <a href="profil-dosen.php" class="px-3"><img src="Asset-img/Alumni.svg" alt="" width="40"
                        height="34"></a>
    ...
    <div class="row justify-content-center mt-4">
        <div class="col-md-10">
            <a href="index-dosen.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <h1 class="display-3 text-start fw-bold mt-3">Azizah hairul</h1>
                <p class="text-start">Frontend
                </p>
            </div>
        </div>
        <!-- Pertanyaan -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="username" name="username" required
                                    placeholder="Masukan Nama Lengkap" aria-describedby="basic-addon3">
                            </div>

                            <!-- Nim -->
                            <label for="username" class="form-label">Nim (saat kuliah)</label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="username" name="username" required
                                    placeholder="Masukan Nama Lengkap" aria-describedby="basic-addon3">
                            </div>
                            ...
                            <!-- Nomor Telpon/HP -->
                            <label for="username" class="form-label">Nomor Telpon/HP</label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="username" name="username" required
                                    placeholder="Masukan Nama Lengkap" aria-describedby="basic-addon3">
                            </div>
                            ...
                            <!-- Tahun MASUK Kuliah -->
                            <label for="username" class="form-label">Tahun Masuk Kuliah</label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="username" name="username" required
                                    placeholder="Masukan Nama Lengkap" aria-describedby="basic-addon3">
                            </div>
                            ...
                            <!-- Tahun LULUS Kuliah -->
                            <label for="username" class="form-label">Tahun Lulus Kuliah</label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="username" name="username" required
                                    placeholder="Masukan Nama Lengkap" aria-describedby="basic-addon3">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="email" name="email" required
                                    placeholder="Masukan Email" aria-describedby="basic-addon3">
                            </div>
