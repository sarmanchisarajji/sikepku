...
<html lang="en">
  ...
  <body>
    ...
    <div class="row justify-content-center mt-4">
      <div class="col-md-10">
        <a href="index-mhs.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-10">
          <h1 class="display-3 text-start fw-bold mt-3">Zafira Khairul</h1>
          <p class="text-start">NIM: E1E1220087
          </p>
      </div>
    </div>
     <!-- Pertanyaan -->
